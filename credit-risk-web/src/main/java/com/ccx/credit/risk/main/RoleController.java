...
import com.ccx.credit.risk.enterprise.EnterpriseController;
...
import com.ccx.credit.risk.shiro.ReloadAuthorizing;
...
public class RoleController extends BasicController{
    ...
    @PostMapping("/findAll")
	@ResponseBody
	@Record(operationType="查询所有角色",
			operationBasicModule="系统管理",
			operationConcreteModule ="角色管理")
	...
	@Record(operationType="跳转角色编辑页",
			operationBasicModule="系统管理",
			operationConcreteModule ="编辑角色")
	...
	@Record(operationType="跳转角色添加页",
			operationBasicModule="系统管理",
			operationConcreteModule ="新增角色")
    public String add(){
		return "/role/addRole";
    }
	...
	@Record(operationType="权限设置",
			operationBasicModule="系统管理",
			operationConcreteModule ="设置权限")
