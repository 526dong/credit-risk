...
<head>
	<meta charset="utf-8">
	<title>大中型企业内部评级-受评企业数据库列表-受评企业数据库评级历史</title>
...
<script type="text/javascript">
    ...
    function getData(){
        $.ajax({
            url:"${ctx}/enterprise/findEvaluateHistory",
            type:'POST',
            data:{
                entId:${entId},
    ...
    function createTable(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            htmlContent += "<a class='operate_a2 detail_btn' title='查看' href='javascript:;' onClick=\"CommitSubjectDetail("+data[i].id+",'"+data[i].ratingApplyNum+"', 'approvalHistory');\"></a>";
	...
	<div class="main_center">
		...
		<div class="right_content">
			<h3 class="place_title">
				...
				<strong>/</strong>
				<a href="${ctx}/enterprise/evaluateList">受评企业数据库列表</a>
				<strong>/</strong>
				<a href="javascript:void(0)" class="active">受评企业数据库评级历史</a>
			</h3>
			<div class="module_box">
				<div class="information_title">
					<a href="javascript:history.back(-1);">返回</a>
				</div>
				<div class="statementData statementData1" style="height: 430px;">
					<form>
